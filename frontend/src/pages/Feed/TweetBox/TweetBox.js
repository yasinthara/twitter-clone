...
function TweetBox() {
    ...
    const handleUploadImage = e => {
        ...
        axios.post("https://api.imgbb.com/1/upload?key=d7fee695599dc824816c8e548aff0b1f", formData)
            .then(res => {
    ...
    return <div className="tweetBox">
        <form onSubmit={handleTweet}>
            ...
            <div className="imageIcon_tweetButton">
                ...
                />  
                <Button className="tweetBox__tweetButton" type="submit">{t('Tweet')}</Button>
            </div>
        </form>
